...
public class WindEvent extends BasicEvent implements IWindEvent {

	final KindOfEvent kind = KindOfEvent.WIND;
	
	protected WindEvent(final String name, final Wind wind) {
		super(name, wind);
	}
